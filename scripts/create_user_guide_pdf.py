...
def build_pdf(output):
    ...
    step_card(pdf, "1", "MAP EDITOR", "Work on the largest canvas view. Select pins directly on the map and refine coordinates, labels, symbols, and colors in the inspector.", 40, 190, 166, 96)
    step_card(pdf, "2", "LOCATIONS", "Open the searchable location manager to import CSV data, add pins, organize the full list, and edit the selected place.", 223, 190, 166, 96, SOFT_NAVY, NAVY)
    step_card(pdf, "3", "MAP STYLE", "Focus on global geography and state appearance: fills, boundaries, county lines, label halo, abbreviations, and legend.", 406, 190, 166, 96, PALE, BLUE)
    pdf.setFillColor(NAVY)
