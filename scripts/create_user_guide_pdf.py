...
def build_pdf(output):
    ...
    bullet(pdf, "Prepare", "Create, rename, toggle, or remove layers; assign locations; target CSV imports; set one shared pin style; or stage other map changes.", 40, 270, 250, BLUE)
