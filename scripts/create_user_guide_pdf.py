...
def build_pdf(output):
    ...
    step_card(pdf, "2", "EDIT", "Select a row or pin. Change coordinates, pin symbol, color, size, label, placement, notes, and visibility in the inspector.", 223, 190, 166, 96, SOFT_NAVY, NAVY)
    ...
    y = bullet(pdf, "Pins", "pin_type (pin, circle, square, diamond, or star), pin_color, and pin_size from 6 through 40.", 40, y - 5, 250, BLUE)
    ...
    y2 = bullet(pdf, "Save project", "Save project creates a .usmap.json file containing map styling, every location, labels, custom data, schema, and timestamps.", 318, y2 - 5, 254, BLUE)
    ...
    step_card(pdf, "4", "JSON", "The complete editable project, not a flattened picture. Reopen it to continue work.", 442, 516, 130, 92, SOFT_GREEN, GREEN)
